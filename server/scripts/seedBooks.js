...
const books = [
  ...
  // BTech CSE
  { title:'Introduction to Algorithms',               author:'Thomas H. Cormen',      category:'BTech CSE',     rentPrice:35, buyPrice:799, isbn:'9780262033848', image:ol('9780262033848') },
  { title:'The C Programming Language',               author:'Brian W. Kernighan',    category:'BTech CSE',     rentPrice:25, buyPrice:499, isbn:'9780131103627', image:ol('9780131103627') },
  { title:'Clean Code',                               author:'Robert C. Martin',      category:'BTech CSE',     rentPrice:28, buyPrice:599, isbn:'9780132350884', image:ol('9780132350884') },
  { title:'The Pragmatic Programmer',                 author:'Andrew Hunt',           category:'BTech CSE',     rentPrice:28, buyPrice:599, isbn:'9780135957059', image:ol('9780135957059') },
  { title:'Design Patterns',                          author:'Erich Gamma',           category:'BTech CSE',     rentPrice:30, buyPrice:649, isbn:'9780201633610', image:ol('9780201633610') },
  { title:'Head First Java',                          author:'Kathy Sierra',          category:'BTech CSE',     rentPrice:28, buyPrice:599, isbn:'9780596009205', image:ol('9780596009205') },
  { title:'Effective Java',                           author:'Joshua Bloch',          category:'BTech CSE',     rentPrice:30, buyPrice:649, isbn:'9780134685991', image:ol('9780134685991') },
  { title:'Python Crash Course',                      author:'Eric Matthes',          category:'BTech CSE',     rentPrice:22, buyPrice:449, isbn:'9781593279288', image:ol('9781593279288') },
  { title:'Automate the Boring Stuff with Python',    author:'Al Sweigart',           category:'BTech CSE',     rentPrice:20, buyPrice:399, isbn:'9781593275990', image:ol('9781593275990') },
  { title:'Cracking the Coding Interview',            author:'Gayle Laakmann McDowell',category:'BTech CSE',   rentPrice:25, buyPrice:549, isbn:'9780984782857', image:ol('9780984782857') },
  { title:'Artificial Intelligence: A Modern Approach',author:'Stuart Russell',       category:'BTech CSE',     rentPrice:35, buyPrice:799, isbn:'9780136042594', image:ol('9780136042594') },
  { title:'Deep Learning',                            author:'Ian Goodfellow',        category:'BTech CSE',     rentPrice:35, buyPrice:799, isbn:'9780262035613', image:ol('9780262035613') },
  { title:'Operating System Concepts',                author:'Abraham Silberschatz',  category:'BTech CSE',     rentPrice:30, buyPrice:699, isbn:'9781118063330', image:ol('9781118063330') },
  { title:'Computer Networks',                        author:'Andrew S. Tanenbaum',   category:'BTech CSE',     rentPrice:30, buyPrice:699, isbn:'9780132126953', image:ol('9780132126953') },
  { title:'Database System Concepts',                 author:'Abraham Silberschatz',  category:'BTech CSE',     rentPrice:30, buyPrice:699, isbn:'9780078022159', image:ol('9780078022159') },
];
